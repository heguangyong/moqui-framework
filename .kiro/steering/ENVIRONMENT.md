...
```
- 自动启动 Moqui 后端 (端口 8080)
- 自动启动 Novel Anime Desktop 前端
- 检查 Java 和 Node.js 环境
- 监控应用状态
...
**PID 文件**:
- `.moqui.pid` - Moqui 后端进程 ID
- `.frontend.pid` - 前端应用进程 ID

**日志文件**:
- `runtime/log/moqui.log` - Moqui 运行日志
- `runtime/log/moqui-startup.log` - Moqui 启动日志
