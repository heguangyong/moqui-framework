...
echo "✅ Current ngrok tunnel: https://0ac14410e289.ngrok-free.app"
echo "✅ Webhook URL: https://0ac14410e289.ngrok-free.app/rest/s1/mcp/telegram"
...
RESPONSE=$(curl -s "https://0ac14410e289.ngrok-free.app/rest/s1/mcp/telegram" \
  -X POST \
